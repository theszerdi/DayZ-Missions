...
_crate addMagazineCargoGlobal ["Skin_CamoWinter_DZN", 3];

_crate addMagazineCargoGlobal ["Skin_Sniper1_DZ", 3];
...
_crate addWeaponCargoGlobal ["Makarov", 1];

_crate addWeaponCargoGlobal ["MakarovSD_DZN", 1];

_crate addWeaponCargoGlobal ["Sa61_EP1", 1];

_crate addWeaponCargoGlobal ["UZI_EP1", 1];

// Magazines
_crate addMagazineCargoGlobal ["7Rnd_45ACP_1911", 8];
...
_crate addMagazineCargoGlobal ["6Rnd_45ACP", 8];

_crate addMagazineCargoGlobal ["10Rnd_B_765x17_Ball", 8];

_crate addMagazineCargoGlobal ["20Rnd_B_765x17_Ball", 8];
...
_crate addWeaponCargoGlobal ["M1014", 1];
...
_crate addMagazineCargoGlobal ["30Rnd_545x39_AKSD", 8];
...
_crate addMagazineCargoGlobal ["10Rnd_127x99_m107", 8];
...
_crate addMagazineCargoGlobal ["100Rnd_762x51_M240", 32];
...
_crate addMagazineCargoGlobal ["100Rnd_556x45_BetaCMag", 8];
...
_crate addMagazineCargoGlobal ["8Rnd_B_Beneli_74Slug", 8];
...
_crate addMagazineCargoGlobal ["Mine", 8];

_crate addMagazineCargoGlobal ["MineE", 8];

_crate addMagazineCargoGlobal ["HandGrenade", 8];

_crate addMagazineCargoGlobal ["HandGrenade_East", 8];

_crate addMagazineCargoGlobal ["HandGrenade_West", 8];

_crate addMagazineCargoGlobal ["SmokeShellRed", 8];
